...
module.exports = async function ({
    ...
    for (let i = 0; i < ONLINETOKENS.TOKENS.length; i ++) {
        ...
        resultTokens.push({
            ...
            logoURI: 'https://exchange.cairo.finance/images/coins/' + onlineToken.address + '.png',

        });
    }
    let resultJson = {
        name: 'Cairo Default List',        
        version: {
            major: 2,
            minor: 10,
            patch: 0,
        ...
        logoURI: 'https://exchange.cairo.finance/images/cairo.png',
        keywords: [
            'cairo', 'default'
        ],
        tokens: resultTokens,
...
module.exports.tags = ['ExportTokensForFront'];
